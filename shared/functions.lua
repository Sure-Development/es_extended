...
local weapons = require('settings.weapons')
...
CreateThread(function()
  for index, weapon in pairs(weapons.list) do
...
function ESX.GetWeaponList(byHash)
  return byHash and weaponsByHash or weapons.list
end
